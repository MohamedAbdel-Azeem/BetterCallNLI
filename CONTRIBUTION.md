...
| Abdelrahman Wael | IntentRouter (keyword fast-path + LLM-based routing with runtrace ToolCall emission), interactive CLI hypothesis picker (subset selection before pipeline run), retrieved-precedents display in verdict output, and @contract syntax for the interactive CLI. |
