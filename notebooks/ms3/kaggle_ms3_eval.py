...
Auto-generated by scripts/build_kaggle_bundle.py on 2026-06-21T22:52:00+00:00Z.
...
Bundled source files (in order):
  ...
  - src/bettercallnli/retrieval/graphrag_utils.py
...
pass  # [bundled] from .base import BaseRetriever
pass  # [bundled] from .graphrag_utils import (
...
---------------
    ...
    pass  # [bundled] from bettercallnli.agent.local_inference_client import install_as_global_client
    install_as_global_client(model, tokenizer)

    pass  # [bundled] from bettercallnli.agent.orchestrator import build_orchestrator
...
try:
    pass  # [bundled] from bettercallnli.enrichment.playbook_enricher import PlaybookEnricher  # type: ignore
    _HAS_TASK4_ENRICHER = True
except Exception:
...
try:
    pass  # [bundled] from bettercallnli.utils.runtrace import RuntraceFormatter  # type: ignore
    _HAS_TASK4_FORMATTER = True
except Exception:
...
def run_evaluation(
    ...
    *,
    ...
    if has_task4_via_orchestrator:
        pass  # [bundled] from bettercallnli.agent.history import ConversationHistory  # type: ignore
...
def _main() -> int:
    ...
    pass  # [bundled] from bettercallnli.agent.orchestrator import build_orchestrator
    pass  # [bundled] from bettercallnli.utils.contract_loader import get_test_contracts
